...
import vanda.com.FtpToFile.unit.FtpUtil;
...
/** FTP地址 *//*
	...
	private final String IP_ADDRESS = "169.254.156.235";

	*/
/** FTP端口 *//*

	private final Integer PORT = 2121;

	*/
/** FTP用户名 *//*

	private final String USERNAME = "lyw";
...
/**
	...
	public  void recursiveDownloadTest()  throws IOException {
		...
		try {
			// 执行下载 D:\ftpTest
			*/
/*result = ftpUtil.recursiveDownloadFile("/",
